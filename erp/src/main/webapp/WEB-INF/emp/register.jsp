		...
		<form class="form-horizontal" action="/erp/emp/insert.do"
			...
			<fieldset>
				...
				<div class="form-group" style="padding: 40px">
					<p class="centered">
						<img src="/erp/images/myphoto.jpg" id="userImage"
							style="width: 100px">
					</p>
					<div>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="phonehome" name="phonehome"
							placeholder="집전화" class="form-control">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="phoneco" name="phoneco" placeholder="회사전화"
							class="form-control">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="phonecell" name="phonecell"
							placeholder="핸드폰번호" class="form-control">
